...
实现一个完整的订单异步处理子系统：生产者、工作队列、confirm、manual ack、prefetch、TTL 重试、DLQ、幂等、监控
...
你写出自己的 RabbitMQ 学习笔记，至少包括模型图、可靠性策略、重试策略、队列类型选择、线上排障指标

## 重点资料

Clustering、Prometheus、Quorum Queues、Streams、Reliability
